...
typedef enum {
  ...
  SB_ASSIGN, SB_ASSIGN_PLUS, SB_ASSIGN_SUBTRACT, SB_ASSIGN_TIMES, SB_ASSIGN_DIVIDE,
  SB_EQ, SB_NEQ, SB_LT, SB_LE, SB_GT, SB_GE,
  SB_PLUS, SB_MINUS, SB_TIMES, SB_SLASH,
  SB_LPAR, SB_RPAR, SB_LBRACKET, SB_RBRACKET
} TokenType; 
